...
public class CarRunner {
    public static void main(String[] args) {
        ...
        // If you're looking at the variable, focus on the data type of the object;
        // If you're looking for method, focus on the constructor of the object.


        /*
        1) When you try to access a "variable" by using an object in inheritance, start to look for
             the "variable" in the class used in the "data type of the object"

        2) When you try to access a "method" by using an object in inheritance, start to look for the
           "object" in the class whose "constructor" was used
