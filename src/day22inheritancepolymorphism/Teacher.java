...
public class Teacher {
    /*
        ...
        4)"private" methods can be "overloaded" because everything is happening in the same class
        5)"final" methods can be "overloaded"... final methods restrict us from changing method
           body, not method parameters
        6)"static" methods can be "overloaded"

        7)Why do we need "Method Overloading"?

        Note: Method Overloading + Method Overriding = Polymorphism (multiple forums)
